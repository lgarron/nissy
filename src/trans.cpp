...
static int ep_mirror[12] = {
		[UF] = UF, [UL] = UR, [UB] = UB, [UR] = UL, [DF] = DF, [DL] = DR, [DB] = DB, [DR] = DL, [FR] = FL, [FL] = FR, [BL] = BR, [BR] = BL};

static int cp_mirror[8] = {
		[UFR] = UFL, [UFL] = UFR, [UBL] = UBR, [UBR] = UBL, [DFR] = DFL, [DFL] = DFR, [DBL] = DBR, [DBR] = DBL};

static int cpos_mirror[6] = {
		[U_center] = U_center, [D_center] = D_center, [R_center] = L_center, [L_center] = R_center, [F_center] = F_center, [B_center] = B_center};
...
Trans inverse_trans(Trans t)
{
	static Trans inverse_trans_aux[NTRANS] = {
			[uf] = uf, [ur] = ul, [ul] = ur, [ub] = ub, [df] = df, [dr] = dr, [dl] = dl, [db] = db, [rf] = lf, [rd] = bl, [rb] = rb, [ru] = fr, [lf] = rf, [ld] = br, [lb] = lb, [lu] = fl, [fu] = fu, [fr] = ru, [fd] = bu, [fl] = lu, [bu] = fd, [br] = ld, [bd] = bd, [bl] = rd,
